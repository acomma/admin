...
INSERT INTO `role` (`role_id`, `name`, `create_time`, `update_time`) VALUES (1000, '系统管理员', NOW(), NOW());
...
INSERT INTO `user` (`user_id`, `username`, `password`, `create_time`, `update_time`) VALUES (1000, 'admin', '{noop}123456', NOW(), NOW());
